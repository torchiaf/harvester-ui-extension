...
const wait = (milliseconds: number): Promise<unknown> => new Promise((resolve) => setTimeout(resolve, milliseconds));
 ...
 */
export default class HarvesterSteveSchema extends Resource {
